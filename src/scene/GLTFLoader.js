...
// 2021年7月25日13:21:57 hxy
const imageLoader = new THREE.ImageLoader();
let materialMap = {};
const parseNromalMap = (needsSetMap, def, needsSetList) => {
  needsSetList.forEach(typeName => {
    def[typeName] !== undefined && (needsSetMap[typeName] = def[typeName]);
  });
};
const parseMaterial = (material, materialDef) => {
  const needsParsetextureList = ["alphaMap"];
  const needsParseNromalList = ["depthTest", "alphaTest"];
  parseNromalMap(material, materialDef, needsParseNromalList);
  const preseTextureEach = needsParsetextureList.map(textureName => {
    const textureUuid = materialDef[textureName];
    if (!textureUuid) return null;
    const imgDataUrl = materialMap[textureUuid];
    // console.log(typeof imgDataUrl, "typeof");
    // if (typeof imgDataUrl !== "string")
    //     return (material[textureName] = imgDataUrl);
  ...
  const promiseList = preseTextureEach.filter(item => item);
  Promise.all(promiseList).then(_ => (material.needsUpdate = true));
};

var dracoLoader = new DRACOLoader();
dracoLoader.setDecoderPath("./threeLibs/draco/");
// 2021年7月25日13:21:57 hxy
...
var GLTFLoader = (function() {
  ...
  GLTFLoader.prototype = Object.assign(Object.create(Loader.prototype), {
    ...
    parse: function(data, path, onLoad, onError) {
      ...
      // 2021年7月25日13:21:57 hxy
      if (json.asset.materialMap) materialMap = json.asset.materialMap;
      // 2021年7月25日13:21:57 hxy
        ...
        for (var i = 0; i < json.extensionsUsed.length; ++i) {
          ...
          switch (extensionName) {
            ...
            case EXTENSIONS.KHR_DRACO_MESH_COMPRESSION:
              // console.log(this.dracoLoader, "this.dracoLoader");
  ...
  GLTFDracoMeshCompressionExtension.prototype.decodePrimitive = function(
    ...
    // console.log(dracoLoader, "dracoLoaderdracoLoader");
  ...
  GLTFParser.prototype.loadMaterial = function(materialIndex) {
    ...
    // 2021年7月28日17:44:16 hxy
    if (materialDef.depthWrite !== undefined) {
      materialParams.depthWrite = materialDef.depthWrite;
    }
    // 2021年7月28日17:44:16 hxy
    ...
    if (alphaMode === ALPHA_MODES.BLEND) {
      ...
      // 2021年7月26日13:35:20 hxy
      // materialParams.depthWrite = false;

      // 2021年7月26日13:35:26 hxy
    } else {
  ...
  GLTFParser.prototype.loadNode = function(nodeIndex) {
    ...
    return (function() {
      ...
      // 2021年7月25日14:22:53 hxy
      if (nodeDef.visible !== undefined) {
        node.visible = nodeDef.visible;
      }

      //  2021年7月25日15:40:59 hxy
      if (nodeDef.renderOrder) {
        node.renderOrder = nodeDef.renderOrder;
      }
      //  2021年7月25日15:40:59 hxy

      if (nodeDef.extras) {
        // console.log(nodeDef.extras, "nodeDef.extras");
        // const alphaMap = nodeDef.extras.alphaMap;
        // if (alphaMap) {
        //     parseMaterial(node, "alphaMap", alphaMap);
        // }
      }
      // 2021年7月25日14:22:53 hxy
  ...
  GLTFParser.prototype.loadScene = (function() {
    ...
    function buildNodeHierachy(nodeId, parentObject, json, parser) {
      ...
      return parser
        ...
        .then(function(node) {
          // begin 2021年7月23日09:54:52 hxy 设置解析userData中的visible属性，并渲染到模型上
          const visible = node.userData.visible;
          if (visible !== undefined) node.visible = visible;
          // end 2021年7月23日09:55:29
